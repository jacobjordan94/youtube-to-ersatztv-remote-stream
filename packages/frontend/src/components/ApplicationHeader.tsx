...
export default function () {
  return (
    <div className="text-center mb-12 drop-shadow-sm drop-shadow-white">
      <h1 className="text-4xl font-bold text-gray-200 mb-4">YouTube to ErsatzTV</h1>
      <div className="flex gap-4 items-center justify-center">
        <img src="images/youtube.webp" className="h-[48px]" alt="Youtube Logo" />
        <ArrowBigRight className="fill-white text-white scale-150" />
        <img src="images/ersatz.webp" className="h-[68px]" alt="ErsatzTV Logo" />
      </div>
